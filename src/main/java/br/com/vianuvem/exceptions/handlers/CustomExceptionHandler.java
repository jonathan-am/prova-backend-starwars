package br.com.vianuvem.exceptions.handlers;
...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ErrorResponse> handleNaoExisteException(NaoEncontradoException ex, WebRequest request) {
    ...
    public final ResponseEntity<ErrorResponse> handleCreateErrorException(CreateErrorException ex, WebRequest request) {
